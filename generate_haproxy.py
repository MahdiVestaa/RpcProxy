...
def render_haproxy(
    ...
    lines.extend(
        [
            ...
            "    acl allow_local_src src 127.0.0.1/32 ::1",
            "    http-request deny deny_status 403 unless allow_rpc_src or allow_local_src",
    ...
    lines.extend(
        [
            ...
            "    acl allow_local_src src 127.0.0.1/32 ::1",
            "    http-request deny deny_status 403 unless allow_metrics_src or allow_local_src",
